		...
		<div className="min-h-screen bg-gray-50 p-6">
			<div className="max-w-4xl mx-auto">
				<div className="mb-6 flex items-center justify-between flex-wrap gap-2">
					<h1 className="text-2xl font-bold text-gray-900">Statistici vechi (set întrebări 1)</h1>
					<Link
						href="/"
				...
				<div className="bg-white rounded-lg shadow-md p-4 mb-6">
					<div className="flex items-center justify-between gap-1 mb-1 flex-wrap">
						<h3 className="text-sm font-bold text-indigo-600">LIVE (survey_responses)</h3>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q1 DA/NU Admin</p>
					...
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q2 % cheltuieli</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
								<PieChart>
									<Pie
					...
					{/* Q3 + Q4 */}
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q3 Impediment (1-5)</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
					...
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q4 Justificare (1-5)</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
					...
					{/* Q5 + Q6 */}
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q5 Capabil (1-5)</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
					...
					<div className="bg-white rounded-lg shadow p-4">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q6 Influență (1-5)</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
					...
					<div className="bg-white rounded-lg shadow p-4 md:col-span-2">
						<p className="text-xs font-medium text-gray-700 mb-0.5">Q7 Sumă lunară</p>
						<div className="h-[160px]">
							<ResponsiveContainer width="100%" height="100%">
								<PieChart>
									<Pie
